...
st.markdown('<div class="header-sub auto-text">🧠 Event Timeline Generator & Multi-Source News Analyzer</div>', unsafe_allow_html=True)

st.markdown("<div class='auto-text'>🔍 Enter An Event Or Topic</div>", unsafe_allow_html=True)
...
with cols[0]:
    st.markdown("<div class='auto-text'>Max articles</div>", unsafe_allow_html=True)
    max_articles = st.number_input("", min_value=3, max_value=20, value=8, step=1, label_visibility="collapsed")
with cols[1]:
...
if run_button and query.strip():
    ...
    with tab1:
        st.markdown("<div class='auto-text'>### Timeline</div>", unsafe_allow_html=True)
    ...
    with tab2:
        st.markdown("<div class='auto-text'>### 🧠 Event Summary</div>", unsafe_allow_html=True)
        st.markdown(f"<div class='auto-text'>{summary_text}</div>", unsafe_allow_html=True)

    with tab3:
        st.markdown("<div class='auto-text'>### 📊 Sources & Authenticity</div>", unsafe_allow_html=True)
        rows = []
        for a in articles:
